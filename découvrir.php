        ...
        <div class="maincontent bg--white pt--80 pb--55">
        	<div class="container">
        		<div class="row">
                    ...
                    <?php
                    $noom=$_GET['id'];
                        $res = mysqli_query($con,"SELECT * FROM `products` WHERE code='$noom'");
while($raw = mysqli_fetch_assoc($res)){
    echo "
	<div class='product_wrapper' >
<form method='post' action=''>
<input type='hidden' name='code' value=".$raw['code']." />
<div class='image'><img src='images/product/".$raw['image']."'></div>
<div class='name'><a href='single-product.php?id=".$raw["id"]."'>".$raw['nom']."</div>
<div class='price'>DH ".$raw['prix']."</div>
