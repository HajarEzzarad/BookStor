        ...
        <div class="maincontent bg--white pt--80 pb--55">
        	<div class="container">
        		<div class="row">
                    ...
                    <?php
                    $noom=$_GET['id'];
                        $res = mysqli_query($con,"SELECT * FROM `products` WHERE id=$noom");
                            ...
                            <form method="post" action="">
                                ...
                                <div class="col-lg-6 col-12">
        							<div class="wn__fotorama__wrapper">
                                        ...
                                        <a href="1.jpg"><img src="images/product/'.$raw['image'].'" alt=""></a>
                                        </div>
                                    </div>
                                </div>
        						<div class="col-lg-6 col-12">
                                    ...
                                    <div class="product_meta">
                                        <span class="posted_in">Categories: </span> '. $raw["code"].'
