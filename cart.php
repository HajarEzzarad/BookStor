                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="bradcaump__inner text-center">
                        	<h2 class="bradcaump-title">Shopping Panier</h2>
                            <nav class="bradcaump-content">
                              <a class="breadcrumb_item" href="index.php">Home</a>
                              <span class="brd-separetor">/</span>
                              <span class="breadcrumb_item active">Shopping Panier</span>
                            </nav>
                        </div>
                    </div>
                </div>
...
<td>QAUNTITE</td>
<td>PRIX</td>
<td>PRIX TOTAL DE CHAQUE PRODUIT</td>
</tr> 
<?php 
...
<tr>
<td>
<img src='images/product/<?php echo $product["image"]; ?>' width="50" height="40" />
</td>
<td><?php echo $product["nom"]; ?><br />
...
<td><?php echo "DH ".$product["prix"]; ?></td>
<td><?php echo "DH ".$product["prix"]*$product["quantity"]; ?></td>
</tr>
<?php
...
<strong>TOTAL: <?php echo "DH ".$total_price; ?></strong>
<br>
<button type="submit" value="Commander"><a href='checkout.php'>Commander</button>
</td>
</tr>
</tbody>
</table> 
