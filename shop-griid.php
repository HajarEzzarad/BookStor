        				...
        				<div class="row">
        					<div class="col-lg-12">
								<div class="shop__list__wrapper d-flex flex-wrap flex-md-nowrap justify-content-between">
									...
									$result = mysqli_query($con,"SELECT * FROM souscategorie,products WHERE souscategorie.id='$iid' and souscategorie.name=products.code");
								$total_row=0;
...
?>
	   ...
	   $(document).ready(function(){
		   ...
		   function filter_data()
		   {
			   ...
			   $.ajax({
				   url:"feetch_data.php?ID=<?php echo $_GET['id']; ?>",
				   method:"POST",
